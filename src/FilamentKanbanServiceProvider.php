...
namespace Solutionforest\FilamentKanban;
...
use Solutionforest\FilamentKanban\Commands\FilamentKanbanCommand;
use Solutionforest\FilamentKanban\Testing\TestsFilamentKanban;
...
class FilamentKanbanServiceProvider extends PackageServiceProvider
{
        ...
        $package->name(static::$name)
            ...
            ->hasInstallCommand(function (InstallCommand $command) {
                $command
                    ...
                    ->publishMigrations()
                    ->askToRunMigrations()
                    ->askToStarRepoOnGitHub('solution-forest/filament-kanban');
            });
    ...
    {
        return 'solution-forest/filament-kanban';
    }
